...
public enum ErrorCode {
    ...
    // Related to CATEGORY
    // ----------------------------------
    CATEGORY_3001(4001, HttpStatus.BAD_REQUEST, "Category existed"),
    CATEGORY_3002(4002, HttpStatus.BAD_REQUEST, "Category not found"),
    // ----------------------------------
    // Related to PRODUCT
    // ----------------------------------
    PRODUCT_3001(4001, HttpStatus.BAD_REQUEST, "Product existed"),
    PRODUCT_3002(4002, HttpStatus.BAD_REQUEST, "Product not found"),
    // ----------------------------------
    // Related to USER
    // ----------------------------------
